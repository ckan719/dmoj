...
SECRET_KEY = '!5&no^8*ooxs&8c7+chn5yz@s1+d)*n)g*=x&_giopy$^o*x*0'
...
ALLOWED_HOSTS = ['stu-dmoj.cf', '127.0.0.1', 'localhost']
...
EMAIL_HOST_USER = 'ncnhat1999@gmail.com'
EMAIL_HOST_PASSWORD = 'congnhat9A1'
EMAIL_PORT = 587
